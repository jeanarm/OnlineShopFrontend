...
const OrderDetailsPageComponent = ({getOrder}) => {
    ...
    useEffect(()=>{
        ...
        .then((order)=>{
            ...
            order.isDelivered ? setIsDelivered(order.deriveredAt):setIsDelivered(false)
      ...
      <Row className="mt-4">
        ...
        <Col md={8}>
          <Row>
            <Col md={6}>
              ...
              <b>Adress</b>: {userInfo.address}{userInfo.city}{userInfo.state} {userInfo.zipCode} <br />
            ...
            <Col>
              <Alert className="mt-3" variant={isDelivered ? "success" : "danger"}>
                {isDelivered ? <>DeLivered at {isDelivered} </>: <>Not Detivered</>}
              </Alert>
            </Col>
            <Col>
        ...
        <Col md={4}>
            <ListGroup>
                ...
                <ListGroup.Item>
                Item Price (after tax):<span className="fw-bold">{cartSubtotal}</span>
                </ListGroup.Item>
                <ListGroup.Item>
